...
var w = [], y = function t(e) {
    ...
    return C(t, [ {
        ...
        value: function(t, e) {
            ...
            if ("dev" !== this.config.env) {
                ...
                p().then(function(i) {
                    if (o.error.length) {
                        var s = "c=" + encodeURIComponent(JSON.stringify(o.error));
                        o.error = [], n({
                            url: r.config.reportUrl + "/api/log?v=1&" + a(o.config, i),
                            data: s,
                            method: "POST",
                            header: {
                                "content-type": "application/x-www-form-urlencoded;"
    ...
    return O(t, [ {
        key: "pushRequest",
        value: function(t) {
            var e = this, n = t.requestbyte, r = void 0 === n ? "" : n, o = t.responsebyte, i = void 0 === o ? "" : o, a = t.statusCode, s = void 0 === a ? "" : a, u = t.resourceUrl, c = void 0 === u ? "" : u, f = t.responsetime, l = void 0 === f ? "" : f, h = t.firstCategory, v = void 0 === h ? "" : h, d = t.secondCategory, g = void 0 === d ? "" : d, w = t.logContent, y = void 0 === w ? "" : w, k = Date.now(), m = this.config, b = m.project, j = m.unionId;
            p().then(function(t) {
                var n = t.network, o = t.os, a = t.pageUrl;
                e.data += "S\t\t\t" + n + "\t\t" + o + "\t" + j + "\n      " + c + "\t" + k + "\t" + r + "\t" + i + "\t" + l + "\t" + b + "\t" + a + "\t" + s + "\t" + v + "\t" + g + "\t" + y + "\n";
            });
        }
    }, {
        key: "report",
...
}(), P = void 0, D = void 0, L = void 0, M = function() {
    function t(e, n) {
        g(this, t), this.config = new y(e, n), this.error = P = new x(this.config), this.resource = D = new S(this.config), 
        this.pageSpeed = L = new U(this.config), E("cat-sdk-wxmp", this.config);
    }
    return I(t, [ {
        key: "newMetric",
        value: function() {
...
exports.Owl = M, exports.page = function(t) {
    ...
    t.onLaunch = function(t) {
        L.appLaunch(), n.call(this, t);
    }, t.onError = function(t) {
        P.onError(t), r && r.call(this, t);
    }, t.onHide = function() {
        P.report(), D.report(), L.report(), o && o.call(this);
    }, e(t);
    ...
    e.complete = function(e) {
        ...
        if (a && "request:fail" !== c) {
            var v = a(e) || {}, d = v.log, g = void 0 === d ? "" : d, w = v.code, y = void 0 === w ? 200 : w, k = v.name, m = void 0 === k ? "" : k, b = "";
            (g || m) && (b = "ajaxError"), h = {
                statusCode: n + "|" + y,
                logContent: g,
                firstCategory: b,
