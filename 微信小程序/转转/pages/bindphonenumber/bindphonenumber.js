    ...
    return _inherits(r, e), _createClass(r, [ {
        ...
        value: function(e) {
            _wxPromise.wxPromise.redirectTo({
                url: "/subPages/trade/bindphonenumber/bindphonenumber?" + _querystring2.default.stringify(e)
            });
        }
    } ]), r;
}(_wepy2.default.page);

Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(_default, "pages/bindphonenumber/bindphonenumber"));