    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function(e) {
            _wxPromise.wxPromise.redirectTo({
                url: "/subPages/other/youpinIntro/youpinIntro?" + _querystring2.default.stringify(e)
            });
        }
    } ]), t;
}(_wepy2.default.page);

Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(_default, "pages/youpinIntro/youpinIntro"));