...
var _createClass = function() {
...
}, _wepy = require("./../../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _adjustPic = require("./../../lib/adjustPic.js"), _adjustPic2 = _interopRequireDefault(_adjustPic), _GoodsList = require("./../../components/GoodsList.js"), _GoodsList2 = _interopRequireDefault(_GoodsList), _LoadingMore = require("./../../components/LoadingMore.js"), _LoadingMore2 = _interopRequireDefault(_LoadingMore), _PageFrame = require("./../../components/common/PageFrame.js"), _PageFrame2 = _interopRequireDefault(_PageFrame), more = function(e) {
    function t() {
        var e, o, a, r;
        ...
        a.config = {
            ...
            loadStatus: "idle",
            pageType: "",
            pageUrl: "/subPages/trade/detail/detail"
        }, a.methods = {
            loadMore: function() {
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function(e) {
            e.map(function(e) {
                e.strInfoId = e.infoId, e.pic = _adjustPic2.default.handleSingle(e.imgUrl.split("|")[0], 320, 320), 
                e.cityName = e.locations[0], e.businessName = e.locations[1];
            });
        }
    }, {
        key: "loadGoods",
        value: function(e, t) {
            ...
            var a = {
                pageStart: e,
                pageSize: 20,
                infoId: this.$wxpage.options.infoId,
                recType: "sim"
            };
            this.$http({
                url: "https://app.zhuanzhuan.com/zz/transfer/getsimilargoods",
                data: a,
                method: "GET",
                header: {
                ...
                success: function(t) {
                    ...
                    var a = t.data.respData.recommendList;
                    a && a.length > 0 ? (o.formatListData(a), o.goodsList = 1 == e ? a : o.goodsList.concat(a), 
                    o.showPage = !0, o.$apply(), o.pageNum = e, o.$log("MORE-LIST-ITEM-VIEW"), 1 == e && o.setData({
                        scrollTop: 0
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(more, "pages/list/more"));