...
var _wepy = require("./../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _wxPromise = require("./../lib/wxPromise.js"), _webviewCategorys = require("./../data/webviewCategorys.js"), _webviewCategorys2 = _interopRequireDefault(_webviewCategorys), GoodsListC = function(e) {
    function t() {
        var e, r, o, i;
        ...
        o.props = [ "goodsList", "clickItemHandler", "redirect" ], o.data = {
            formId: ""
        }, o.methods = {
            sendFromId: function(e) {
                this.formId = e.detail.formId, this.$apply();
                var t = e.currentTarget.dataset.index, r = this.goodsList[t], o = "/subPages/trade/detail/detail?infoId=" + r.infoId + "&metric=" + r.metric, i = _webviewCategorys2.default.find(function(e) {
