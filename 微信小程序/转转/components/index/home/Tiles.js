...
var _wepy = require("./../../../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _funcKit = require("./../../../lib/funcKit.js"), _default = function(e) {
    function t() {
        ...
        o.props = {
            ...
            onTile: function(e) {
                var t = this.tiles[e], r = "function" == typeof this.correctLinkHandler ? this.correctLinkHandler(t.href) : t.href;
                (0, _funcKit.robustOpen)(r, t.appId), t.clickLog && this.$log(t.clickLog, null, {
                    num: e + 1
                });
            }
