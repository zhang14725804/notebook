    ...
    function t() {
        ...
        o.props = [ "goodsList", "clickItemHandler", "redirect", "pageUrl" ], o.data = {
            ...
            sendFromId: function(e) {
                ...
                var t = e.currentTarget.dataset.index, r = this.goodsList[t], o = "https://m.zhuanzhuan.com/youpin/website/details.html?infoId=" + r.skuId + "&metric=" + r.metricValue;
                o = "/pages/webview/webview?url=" + encodeURIComponent(o), this.redirect ? _wxPromise.wxPromise.redirectTo({
                    url: o
