...
var _class = function(_component) {
    ...
    function _class() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [ this ].concat(args))), 
        _this), _this.$isComponent = false, _this.$preloadData = {}, _this.$prefetchData = {}, 
    ...
    _createClass(_class, [ {
        ...
        value: function $route(type, url) {
            ...
            if (goTo && goTo.onPrefetch) {
                ...
                goTo.$prefetchData = goTo.onPrefetch(params, {
                    from: this,
                    preload: preloadData
                });
            }
