...
var _class = function() {
    ...
    _createClass(_class, [ {
        ...
        value: function $init($wxpage, $root, $parent) {
            ...
            var k = void 0, defaultData = {};
            var props = this.props;
            var key = void 0, val = void 0, binded = void 0;
            var inRepeat = false, repeatKey = void 0;
                        ...
                        if (binded) {
                            if ((typeof binded === "undefined" ? "undefined" : _typeof(binded)) === "object") {
                                (function() {
                                    ...
                                    inRepeat = true;
                                    var bindfor = binded.for, binddata = $parent;
        ...
        value: function setData(k, v) {
            ...
            var t = null, reg = new RegExp("^" + this.$prefix.replace(/\$/g, "\\$"), "ig");
            for (t in k) {
        ...
        value: function $setIndex(index) {
            var _this4 = this;
            this.$index = index;
            var props = this.props, $parent = this.$parent;
            var key = void 0, val = void 0, binded = void 0;
            if (props) {
                for (key in props) {
                    val = undefined;
        ...
        value: function $digest() {
            ...
            while (this.$$phase) {
                ...
                if (this.computed) {
                    for (k in this.computed) {
                        var _fn2 = this.computed[k], val = _fn2.call(this);
