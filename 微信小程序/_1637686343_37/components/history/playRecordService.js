...
exports.default = {
    save: function(e) {
        var a = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 200, o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "aid";
    ...
    remove: function(t) {
        ...
        if (t) {
            var a = e(t, n);
            if (a >= 0) {
                var i = r.default.storage.handleStorageMuti("get", "VIDEO_PLAY_RECORD") || [], o = i.splice(a, 1);
                return r.default.storage.handleStorageMuti("set", "VIDEO_PLAY_RECORD", i), o[0];
            }
        } else r.default.storage.handleStorageMuti("remove", "VIDEO_PLAY_RECORD");
    },
    get: function(e, t) {
