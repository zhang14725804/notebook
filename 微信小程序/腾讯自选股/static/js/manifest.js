(function() {
    (function(a) {
        ...
        var c = global.webpackJsonp;
        global.webpackJsonp = function(d, f, g) {
            for (var h, j, k, l = 0, i = []; l < d.length; l++) j = d[l], e[j] && i.push(e[j][0]), 
            e[j] = 0;
        ...
        b.e = function(a) {
            ...
            h.type = "text/javascript", h.charset = "utf-8", h.async = !0, h.timeout = 12e4, 
            b.nc && h.setAttribute("nonce", b.nc), h.src = b.p + "static/js/" + a + ".js";
            var i = setTimeout(c, 12e4);
